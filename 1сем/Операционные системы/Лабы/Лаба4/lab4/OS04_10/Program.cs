...
class Program
{
    // Количество задач равно количеству логических процессоров
    static int TaskCount = Environment.ProcessorCount;
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Студент ... создает задачи...");
        ...
        for (int i = 0; i < TaskCount; i++)
        {
            ...
            // Ожидание завершения текущей задачи перед запуском следующей
            tasks[i].Wait();
        }

        Console.WriteLine("Студент ... ждет завершения задач...");
