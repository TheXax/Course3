 ...
 */
/* Compiler settings for C:/Лабы/Системное программирование/lab4/ComSampleProxy/IComTest.idl:
...
extern const MIDL_SERVER_INFO ISVA_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISVA_ProxyInfo;
...
/* Object interface: ISVA, ver. 1.0,
   GUID={0x3BEE622B,0x37D6,0x424D,{0x8C,0x7C,0x63,0xFA,0xDB,0x40,0xE3,0xC4}} */

#pragma code_seg(".orpc")
static const unsigned short ISVA_FormatStringOffsetTable[] =
    {
    38
    };

static const MIDL_STUBLESS_PROXY_INFO ISVA_ProxyInfo =
    {
    &Object_StubDesc,
    IComTest__MIDL_ProcFormatString.Format,
    &ISVA_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISVA_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    IComTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _ISVAProxyVtbl = 
{
    &ISVA_ProxyInfo,
    &IID_ISVA,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* ISVA::getThirdDigitFromEnd */
};

const CInterfaceStubVtbl _ISVAStubVtbl =
{
    &IID_ISVA,
    &ISVA_ServerInfo,
    4,
...
const CInterfaceProxyVtbl * const _IComTest_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_ISVAProxyVtbl,
    0
};
...
const CInterfaceStubVtbl * const _IComTest_StubVtblList[] = 
{
    ...
    ( CInterfaceStubVtbl *) &_ISVAStubVtbl,
    0
};
