...
namespace REALFILM.Classes
{
    public class OrdersRepo
    {
        ...
        public List<UserOrder> GetUserOrders(Users userSignedIn)
        {
            try
            {
                var res = from order in context.Orders //все записи из Orders
                ...
                var listOfUserOrders = res.Cast<UserOrder>().ToList();//список заказов покупателя
                ...
                //для получения обновлённого списка заказов
