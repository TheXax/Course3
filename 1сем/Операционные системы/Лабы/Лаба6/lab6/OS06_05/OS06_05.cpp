...
int main()
{
    ...
    LPCWSTR an1 = L"C:\\Лабы\\Операционные системы\\Лабы\\Лаба6\\lab6\\x64\\Debug\\OS06_05A.exe";
    LPCWSTR an2 = L"C:\\Лабы\\Операционные системы\\Лабы\\Лаба6\\lab6\\x64\\Debug\\OS06_05B.exe";
