...
[
  ...
  ["Первый пучок", "образовается", "при отражении от верхней поверхности пластинки."],
  ["Второй пучок", "образовается", "при отражении от нижней поверхности."],
  ...
  ["Изменение угла падения света", "влияет", "на положение интерференционных полос."],
   ...
   let blacklist = []
//поиск сказуемого в вопросе по окончанию
   ...
   function getAnswer(question) {
     ...
     for (let i = 0; i < words.length; i++) {
       ...
       if (ending >= 0) {
         ...
         //создание регулярного выраждения по сказуемому из вопроса
