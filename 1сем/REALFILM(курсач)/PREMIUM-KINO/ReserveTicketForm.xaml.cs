...
namespace REALFILM
{
    public partial class ReserveTicketForm : Window
    {
        ...
        public ReserveTicketForm()
        {
            ...
            selectedSchedule = (Ticket)Application.Current.Properties["selectedSchedule"];//извлекает выбранный эоемент(билет) и приводит к типу Ticket
        ...
        private void SendMail(int count)
        {
            ...
            var mailFrom = new MailAddress("realfilmbot@gmail.com", "REALFILM");
