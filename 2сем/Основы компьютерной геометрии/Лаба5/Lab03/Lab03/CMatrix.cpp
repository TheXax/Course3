...
//Возвращает новую матрицу, содержащую противоположные значения исходной матрицы
...
//Оператор сложения для двух матриц. Проверяет, совпадают ли размеры матриц
...
//Оператор вычитания для двух матриц
CMatrix CMatrix::operator-(CMatrix& M)
// Оператор M1-M2
{
	int bb = (n_rows == M.rows()) && (n_cols == M.cols());
...
//Оператор умножения для двух матриц. Проверяет, соответствуют ли размеры для умножения
CMatrix CMatrix::operator*(CMatrix& M)
...
//Оператор присваивания. Если присваиваемая матрица равна текущей, ничего не делает
