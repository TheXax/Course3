...
char name[] = "Hello"; //Позывной сервера, который будет использоваться для идентификации
char checkServName[] = "CheckServ"; //Позывной для проверки на наличие идентичных серверов
//char servAk[] = "Hello";
